...
@Component({
	selector: 'kt-holmanager',
	templateUrl: './holmanager.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./holmanager.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class HolManagerComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('HolManager');
	}
