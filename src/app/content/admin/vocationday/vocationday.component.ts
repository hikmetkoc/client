...
@Component({
	selector: 'kt-vocationday',
	templateUrl: './vocationday.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./vocationday.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class VocationDayComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('VocationDay');
	}
