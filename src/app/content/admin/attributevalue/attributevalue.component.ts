...
@Component({
	selector: 'kt-attributevalue',
	templateUrl: './attributevalue.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./attributevalue.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class AttributeValueComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('AttributeValue');
	}
