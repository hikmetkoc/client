...
@Component({
	selector: 'kt-ikfile',
	templateUrl: './ikfile.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./ikfile.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class IkfileComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('Ikfile');
