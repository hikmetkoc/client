...
@Component({
	selector: 'kt-customactivity',
	templateUrl: './customactivity.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./customactivity.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class CustomActivityComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('CustomActivity');
	}
	...
	rowClicked(row, reload?) {
		if (reload) {
			...
			this.defaultFilter = [{
				name: 'customactivity.id',
				operator: 'EQUALS',
				value: row.id
			}];
			this.defaultValues = [{
				field: 'customactivityId',
				value: row.id
			}, {
