...
@Component({
	selector: 'kt-contproduct',
	templateUrl: './contproduct.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./contproduct.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class ContProductComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('ContProduct');
	}
