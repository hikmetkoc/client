...
export class DocumentComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('Document');
	...
	evaluateButtons() {
		this.buttons = [];
		if (this.baseService.getUserId() === 2000) {
			this.buttons.push({
