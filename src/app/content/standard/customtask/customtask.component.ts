...
@Component({
	selector: 'kt-customtask',
	templateUrl: './customtask.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./customtask.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class CustomTaskComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('CustomTask');
	}
	...
	activityRowClicked(row) {
		this.router.navigate(['/customactivity'], { queryParams: { id: row.id, sourceObject: this.model.name.toLowerCase(), sourceId: this.current['id'] } });
	}
