...
@Component({
	selector: 'kt-projtask',
	templateUrl: './projtask.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./projtask.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class ProjTaskComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('ProjTask');
	}
	...
	projTaskOfficerRowClicked(row) {
		this.router.navigate(['/projtaskofficer'], { queryParams: { id: row.id, sourceObject: this.model.name.toLowerCase(), sourceId: this.current['id'] } });
	}
	projTaskActivityRowClicked(row) {
		this.router.navigate(['/projtaskactivity'], { queryParams: { id: row.id, sourceObject: this.model.name.toLowerCase(), sourceId: this.current['id'] } });
	}
	getReport() {
