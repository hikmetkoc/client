...
@Component({
	selector: 'kt-projofficer',
	templateUrl: './projofficer.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
	styleUrls: ['./projofficer.component.scss'],
	encapsulation: ViewEncapsulation.None
})
export class ProjOfficerComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('ProjOfficer');
	}
