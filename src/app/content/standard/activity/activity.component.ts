...
export class ActivityComponent extends BaseComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		this.model = Utils.getModel('Activity');
	}
				...
				if (params.filter === 'pendingApproval') {
					...
					this.mainGrid.activeFilter = {
						values: '[{"FieldName":"typeId","Operation":"EqualTo","Value": ' +
							...
							',"Title":"Tipi","ValueTitle":"Etkinlik"}, {"FieldName":"checkInTime","Operation":"GreaterThanOrEqualTo","Value": "' +
							Utils.dateFormatForApi(new Date(y, m, 1)).toString() +
							'","Title":"Planlanan Başlangıç Zamanı"}, {"FieldName":"checkInTime","Operation":"LessThan","Value": "' +
					...
					this.mainGrid.activeFilter = {
						values: '[{"FieldName":"typeId","Operation":"EqualTo","Value": ' +
							...
							',"Title":"Tipi","ValueTitle":"Görev"}, {"FieldName":"checkInTime","Operation":"GreaterThanOrEqualTo","Value": "' +
							Utils.dateFormatForApi(new Date(y, m, 1)).toString() +
							'","Title":"Planlanan Başlangıç Zamanı"}, {"FieldName":"checkInTime","Operation":"LessThan","Value": "' +
							Utils.dateFormatForApi(new Date(y, m + 1, 1)).toString() +
							'","Title":"Planlanan Başlangıç Zamanı"}]'
